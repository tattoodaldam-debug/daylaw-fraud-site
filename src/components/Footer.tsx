    ...
    <footer className="bg-navy-950 text-navy-200">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="flex flex-col gap-8 md:flex-row md:justify-between">
          ...
          <dl className="space-y-2 text-sm">
            <div className="flex gap-3">
              <dt className="w-24 shrink-0 font-bold text-navy-300">주소</dt>
              <dd>서울 서초구 서초동 1624-21</dd>
            </div>
            <div className="flex gap-3">
              <dt className="w-24 shrink-0 font-bold text-navy-300">전화번호</dt>
              <dd>준비 중</dd>
            </div>
            <div className="flex gap-3">
              <dt className="w-24 shrink-0 font-bold text-navy-300">
                온라인 상담
              </dt>
              <dd>준비 중</dd>
            </div>
        ...
        <div className="mt-10 border-t border-navy-800 pt-6">
          ...
          <div className="mt-4 flex flex-col gap-2 text-xs text-navy-300 sm:flex-row sm:items-center sm:justify-between">
